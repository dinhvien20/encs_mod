...
static bool processArgs(int argc, char *argv[],
  ...
  // the mount point.
  if (optind + 3 <= argc) {   //Customer ***g 483 newset 2 change oldset 2
    ...
    out->opts->passw = string(argv[optind++]);  //Customer ***g 489
  } else {
    // no mount point specified
...
int main(int argc, char *argv[]) {
  ...
  // anything that comes from the user should be considered tainted untilopts->rootDir
